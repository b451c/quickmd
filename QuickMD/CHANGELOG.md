...
### Fixed
- **Chrome button hover:** The top-right Edit and Copy pills no longer shove each other when the pointer moves between them. Hovering the pair (or the gap) expands both together; they collapse together after a short delay on leave.
